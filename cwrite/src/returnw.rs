...
pub fn write_return(tree : BinaryExpressionTree , return_type : DataType) -> String {
    ...
    if tree.tree.len() > 1{
	retval.push(write_binary_expression_tree(tree.clone() , write_data_type(return_type)));
